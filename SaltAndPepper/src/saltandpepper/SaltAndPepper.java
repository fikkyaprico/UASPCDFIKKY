...
public class SaltAndPepper {
	...
	BufferedImage image1 = ImageIO.read(new File("C:\\Users\\muhsy\\Desktop\\UASPCDFikky\\MyRoom.jpg"));
	...
	for(int i=0; i<height; i++){
			...
			try{
			      f = new File("C:\\Users\\muhsy\\Desktop\\UASPCDFikky\\MyRoom-saltpepper.png");
